module.exports = {
    ...
    FINAL_STATUS_POLL_INTERVAL_MS: 5000,
    FINAL_STATUS_POLL_ATTEMPTS: 12,
    ...
    MAX_LEVENSHTEIN_LENGTH_RATIO: 0.4,
    ...
    '`/set_team` - set this server\'s default team for team-specific commands and gameday tracking.\n' +
